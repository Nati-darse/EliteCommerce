...
// React.lazy — these heavy chart components load only when dashboard is visited
// Recharts library (~500kb) won't be in the initial bundle
...
// Loading skeleton — shown while lazy component downloads
